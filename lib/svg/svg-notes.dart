...
class SvgNote extends SvgRenderable {
  ...
  <g
    ...
    <path
       style="fill:${NOTATION_FILL_COLOR};fill-rule:evenodd;stroke:${NOTATION_STROKE_COLOR};stroke-width:${NOTATION_STROKE_WIDTH};image-rendering:optimizeQuality;shape-rendering:geometricPrecision;text-rendering:geometricPrecision"
       id="path-${idNumber}"
